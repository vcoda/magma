...
const char *stringize(VkImageCreateFlagBits bit)
{
    ...
    MAGMA_STRINGIZE_FIELD(VK_IMAGE_CREATE_BIND_SFR_BIT_KHX);
    ...
    MAGMA_STRINGIZE_FIELD(VK_IMAGE_CREATE_ALIAS_BIT_KHR);
    }; return MAGMA_UNKNOWN;
}
...
const char *stringize(VkMemoryHeapFlagBits bit)
{
    ...
    MAGMA_STRINGIZE_FIELD(VK_MEMORY_HEAP_MULTI_INSTANCE_BIT_KHX);
    }; return MAGMA_UNKNOWN;
}
