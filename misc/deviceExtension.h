...
namespace magma
{
    ...
    public:
            ...
            bool throwNotPresent)
        {
            ...
            else
            {
                ...
                PFN_vkVoidFunction addr = vkGetDeviceProcAddr(device, name);
                if (addr)
                {
        ...
        operator Function() const { return pfn; }
    ...
    template<typename Function>
    std::map<std::string, PFN_vkVoidFunction> DeviceExtension<Function>::cache;
} // namespace magma
