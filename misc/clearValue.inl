namespace magma
{
constexpr ClearColor::ClearColor(float r, float g, float b, float a /* 1.f */) noexcept
{
...
constexpr ClearColor::ClearColor(int32_t r, int32_t g, int32_t b, int32_t a) noexcept
{
...
constexpr ClearColor::ClearColor(uint32_t r, uint32_t g, uint32_t b, uint32_t a) noexcept
{
...
constexpr ClearColor::ClearColor(uint32_t hexValue) noexcept
{
...
constexpr ClearDepthStencil::ClearDepthStencil(float depth, uint8_t stencil /* 0 */) noexcept
{
