...
namespace magma
{
    namespace packed
    {
        /* Packed vector with corresponding Vulkan format. */
        ...
        struct R4g4b4a4Unorm : Vector<VK_FORMAT_R4G4B4A4_UNORM_PACK16>
        {
            union
            {
                struct
        ...
        struct B4g4r4a4Unorm : Vector<VK_FORMAT_B4G4R4A4_UNORM_PACK16>
        {
            union
            {
                struct
        ...
        struct R5g6b5Unorm : Vector<VK_FORMAT_R5G6B5_UNORM_PACK16>
        {
            union
            {
                struct
        ...
        struct B5g6r5Unorm : Vector<VK_FORMAT_B5G6R5_UNORM_PACK16>
        {
            union
            {
                struct
        ...
        struct R5g5b5a1Unorm : Vector<VK_FORMAT_R5G5B5A1_UNORM_PACK16>
        {
            union
            {
                struct
        ...
        struct B5g5r5a1Unorm : Vector<VK_FORMAT_B5G5R5A1_UNORM_PACK16>
        {
            union
            {
                struct
        ...
        struct R9g9b9e5Ufloat : Vector<VK_FORMAT_E5B9G9R9_UFLOAT_PACK32>
        {
            union
            {
                struct
