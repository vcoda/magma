...
namespace magma
{
    ...
    namespace specialization
    {
        ...
        /* Built-in specializations for scalar vertex input types.
           NOTE: GCC complains about extra qualification for namespace and
           specialization of type in different namespace, so hence we use
           dedicated macro for specialization. */

        #define MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Type, Format)\
        template<> struct VertexAttribute<Type> : VertexAttributeFormat<Format> {}

        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UByteNorm, VK_FORMAT_R8_UNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(ByteNorm, VK_FORMAT_R8_SNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UByte, VK_FORMAT_R8_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Byte, VK_FORMAT_R8_SINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UShortNorm, VK_FORMAT_R16_UNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(ShortNorm, VK_FORMAT_R16_SNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UShort, VK_FORMAT_R16_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Short, VK_FORMAT_R16_SINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Half, VK_FORMAT_R16_SFLOAT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UInt, VK_FORMAT_R32_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Int, VK_FORMAT_R32_SINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Float, VK_FORMAT_R32_SFLOAT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(LargeUInt, VK_FORMAT_R64_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(LargeInt, VK_FORMAT_R64_SINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Double, VK_FORMAT_R64_SFLOAT);

        /* Built-in specializations for vectorized vertex input types. */

        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UByteNorm2, VK_FORMAT_R8G8_UNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(ByteNorm2, VK_FORMAT_R8G8_SNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UByte2, VK_FORMAT_R8G8_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Byte2, VK_FORMAT_R8G8_SINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UByteNorm4, VK_FORMAT_R8G8B8A8_UNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(ByteNorm4, VK_FORMAT_R8G8B8A8_SNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UByte4, VK_FORMAT_R8G8B8A8_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Byte4, VK_FORMAT_R8G8B8A8_SINT);

        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UShortNorm2, VK_FORMAT_R16G16_UNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(ShortNorm2, VK_FORMAT_R16G16_SNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UShort2, VK_FORMAT_R16G16_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Short2, VK_FORMAT_R16G16_SINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UShortNorm3, VK_FORMAT_R16G16B16_UNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(ShortNorm3, VK_FORMAT_R16G16B16_SNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UShort3, VK_FORMAT_R16G16B16_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Short3, VK_FORMAT_R16G16B16_SINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UShortNorm4, VK_FORMAT_R16G16B16A16_UNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(ShortNorm4, VK_FORMAT_R16G16B16A16_SNORM);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UShort4, VK_FORMAT_R16G16B16A16_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Short4, VK_FORMAT_R16G16B16A16_SINT);

        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UInt2, VK_FORMAT_R32G32_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Int2, VK_FORMAT_R32G32_SINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UInt3, VK_FORMAT_R32G32B32_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Int3, VK_FORMAT_R32G32B32_SINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(UInt4, VK_FORMAT_R32G32B32A32_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Int4, VK_FORMAT_R32G32B32A32_SINT);

        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(LargeUInt2, VK_FORMAT_R64G64_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(LargeInt2, VK_FORMAT_R64G64_SINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(LargeUInt3, VK_FORMAT_R64G64B64_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(LargeInt3, VK_FORMAT_R64G64B64_SINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(LargeUInt4, VK_FORMAT_R64G64B64A64_UINT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(LargeInt4, VK_FORMAT_R64G64B64A64_SINT);

        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Half2, VK_FORMAT_R16G16_SFLOAT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Half3, VK_FORMAT_R16G16B16_SFLOAT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Half4, VK_FORMAT_R16G16B16A16_SFLOAT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Float2, VK_FORMAT_R32G32_SFLOAT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Float3, VK_FORMAT_R32G32B32_SFLOAT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Float4, VK_FORMAT_R32G32B32A32_SFLOAT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Double2, VK_FORMAT_R64G64_SFLOAT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Double3, VK_FORMAT_R64G64B64_SFLOAT);
        MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE_INTERNAL(Double4, VK_FORMAT_R64G64B64A64_SFLOAT);
    } // namespace specialization
} // namespace magma

#define MAGMA_SPECIALIZE_VERTEX_ATTRIBUTE(Type, Format)\
    template<>\
    struct magma::specialization::VertexAttribute<Type> :\
