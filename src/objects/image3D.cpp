...
Image3D::Image3D(const std::unique_ptr<CommandBuffer>& cmdBuffer, VkFormat format,
...
Image3D::Image3D(const std::unique_ptr<CommandBuffer>& cmdBuffer, VkFormat format, const std::vector<MipData>& mipMaps,
    std::shared_ptr<Allocator> allocator /* nullptr */,
    const Initializer& optional /* default */,
    const Sharing& sharing /* default */,
