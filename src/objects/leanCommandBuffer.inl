...
inline void LeanCommandBuffer::moveObjects(ClusterAccelerationStructure *accelerationStructure, Buffer *scratchBuffer) const noexcept
{
...
inline void LeanCommandBuffer::buildTriangleCluster(TriangleClusterAccelerationStructure *accelerationStructure, Buffer *scratchBuffer) const noexcept
{
    buildClusterAccelerationStructureIndirect(VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_BUILD_TRIANGLE_CLUSTER_NV, accelerationStructure, scratchBuffer);
}

inline void LeanCommandBuffer::buildTriangleClusterTemplate(TriangleClusterAccelerationStructureTemplate *accelerationStructure, Buffer *scratchBuffer) const noexcept
{
    buildClusterAccelerationStructureIndirect(VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_BUILD_TRIANGLE_CLUSTER_TEMPLATE_NV, accelerationStructure, scratchBuffer);
}

inline void LeanCommandBuffer::instantiateTriangleCluster(TriangleClusterAccelerationStructure *accelerationStructure, Buffer *scratchBuffer) const noexcept
{
    buildClusterAccelerationStructureIndirect(VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_INSTANTIATE_TRIANGLE_CLUSTER_NV, accelerationStructure, scratchBuffer);
}

inline void LeanCommandBuffer::getClusterTemplateIndices(ClusterAccelerationStructure *accelerationStructure, Buffer *scratchBuffer) const noexcept
{
    buildClusterAccelerationStructureIndirect(VK_CLUSTER_ACCELERATION_STRUCTURE_OP_TYPE_GET_CLUSTER_TEMPLATE_INDICES_NV, accelerationStructure, scratchBuffer);
}
