...
inline PipelineLayout::PipelineLayout(lent_ptr<const DescriptorSetLayout> setLayout,
    std::shared_ptr<IAllocator> allocator /* nullptr */,
    VkPipelineLayoutCreateFlags flags /* 0 */):
...
inline PipelineLayout::PipelineLayout(const std::initializer_list<lent_ptr<const DescriptorSetLayout>>& setLayouts,
    std::shared_ptr<IAllocator> allocator /* nullptr */,
    VkPipelineLayoutCreateFlags flags /* 0 */):
