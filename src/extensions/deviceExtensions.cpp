...
DeviceExtensions::DeviceExtensions(const std::shared_ptr<PhysicalDevice>& device):
    ExtensionRegistry<VkExtensionProperties>(device->enumerateExtensions()),

    MAGMA_CHECK_EXTENSION(AMD_anti_lag),
    ...
    MAGMA_CHECK_EXTENSION(ARM_pipeline_opacity_micromap),
    ...
    MAGMA_CHECK_EXTENSION(EXT_attachment_feedback_loop_dynamic_state),
    ...
    MAGMA_CHECK_EXTENSION(EXT_depth_clamp_control),
    ...
    MAGMA_CHECK_EXTENSION(EXT_descriptor_buffer),
    ...
    MAGMA_CHECK_EXTENSION(EXT_device_generated_commands),
    ...
    MAGMA_CHECK_EXTENSION(EXT_external_memory_metal),
    ...
    MAGMA_CHECK_EXTENSION(EXT_frame_boundary),
    ...
    MAGMA_CHECK_EXTENSION(EXT_image_sliced_view_of_3d),
    ...
    MAGMA_CHECK_EXTENSION(EXT_legacy_vertex_attributes),
    MAGMA_CHECK_EXTENSION(EXT_line_rasterization),
    MAGMA_CHECK_EXTENSION(EXT_load_store_op_none),
    MAGMA_CHECK_EXTENSION(EXT_map_memory_placed),
    ...
    MAGMA_CHECK_EXTENSION(EXT_nested_command_buffer),
    ...
    MAGMA_CHECK_EXTENSION(EXT_pipeline_library_group_handles),
    ...
    MAGMA_CHECK_EXTENSION(EXT_present_mode_fifo_latest_ready),
    ...
    MAGMA_CHECK_EXTENSION(EXT_shader_replicated_composites),
    ...
    MAGMA_CHECK_EXTENSION(EXT_vertex_attribute_robustness),
    ...
    MAGMA_CHECK_EXTENSION(HUAWEI_hdr_vivid),
    ...
    MAGMA_CHECK_EXTENSION(KHR_calibrated_timestamps),
    MAGMA_CHECK_EXTENSION(KHR_compute_shader_derivatives),
    ...
    MAGMA_CHECK_EXTENSION(KHR_depth_clamp_zero_one),
    ...
    MAGMA_CHECK_EXTENSION(KHR_dynamic_rendering_local_read),
    ...
    MAGMA_CHECK_EXTENSION(KHR_index_type_uint8),
    MAGMA_CHECK_EXTENSION(KHR_line_rasterization),
    MAGMA_CHECK_EXTENSION(KHR_load_store_op_none),
    ...
    MAGMA_CHECK_EXTENSION(KHR_maintenance6),
    MAGMA_CHECK_EXTENSION(KHR_maintenance7),
    MAGMA_CHECK_EXTENSION(KHR_maintenance8),
    MAGMA_CHECK_EXTENSION(KHR_map_memory2),
    MAGMA_CHECK_EXTENSION(KHR_multiview),
    MAGMA_CHECK_EXTENSION(KHR_performance_query),
    MAGMA_CHECK_EXTENSION(KHR_pipeline_binary),
    ...
    MAGMA_CHECK_EXTENSION(KHR_shader_expect_assume),
    MAGMA_CHECK_EXTENSION(KHR_shader_float16_int8),
    MAGMA_CHECK_EXTENSION(KHR_shader_float_controls),
    MAGMA_CHECK_EXTENSION(KHR_shader_float_controls2),
    MAGMA_CHECK_EXTENSION(KHR_shader_integer_dot_product),
    MAGMA_CHECK_EXTENSION(KHR_shader_maximal_reconvergence),
    MAGMA_CHECK_EXTENSION(KHR_shader_non_semantic_info),
    MAGMA_CHECK_EXTENSION(KHR_shader_quad_control),
    MAGMA_CHECK_EXTENSION(KHR_shader_relaxed_extended_instruction),
    MAGMA_CHECK_EXTENSION(KHR_shader_subgroup_extended_types),
    MAGMA_CHECK_EXTENSION(KHR_shader_subgroup_rotate),
    ...
    MAGMA_CHECK_EXTENSION(KHR_vertex_attribute_divisor),
    MAGMA_CHECK_EXTENSION(KHR_video_decode_av1),
    ...
    MAGMA_CHECK_EXTENSION(KHR_video_encode_av1),
    MAGMA_CHECK_EXTENSION(KHR_video_encode_h264),
    MAGMA_CHECK_EXTENSION(KHR_video_encode_h265),
    MAGMA_CHECK_EXTENSION(KHR_video_encode_quantization_map),
    MAGMA_CHECK_EXTENSION(KHR_video_encode_queue),
    MAGMA_CHECK_EXTENSION(KHR_video_maintenance1),
    MAGMA_CHECK_EXTENSION(KHR_video_maintenance2),
    ...
    MAGMA_CHECK_EXTENSION(NV_cluster_acceleration_structure),
    MAGMA_CHECK_EXTENSION(NV_command_buffer_inheritance),
    MAGMA_CHECK_EXTENSION(NV_compute_shader_derivatives),
    MAGMA_CHECK_EXTENSION(NV_cooperative_matrix),
    MAGMA_CHECK_EXTENSION(NV_cooperative_matrix2),
    MAGMA_CHECK_EXTENSION(NV_cooperative_vector),
    ...
    MAGMA_CHECK_EXTENSION(NV_display_stereo),
    ...
    MAGMA_CHECK_EXTENSION(NV_partitioned_acceleration_structure),
    MAGMA_CHECK_EXTENSION(NV_per_stage_descriptor_set),
    MAGMA_CHECK_EXTENSION(NV_present_barrier),
    MAGMA_CHECK_EXTENSION(NV_present_metering),
    ...
    MAGMA_CHECK_EXTENSION(NV_ray_tracing_linear_swept_spheres),
