...
template<class Type>
inline Type *variant_ptr<Type>::get()
{
    try
    {
...
template<class Type>
inline const Type *variant_ptr<Type>::get() const
{
    try
    {
...
template<class Type>
inline Type *variant_ptr<Type>::operator->()
{
    return get();
}

template<class Type>
inline const Type *variant_ptr<Type>::operator->() const
{
    return get();
}
