...
MAGMA_INLINE void hashCombineArg(size_t& seed, const Type& arg) noexcept
{
...
template<typename Type>
MAGMA_INLINE void __nextHash(size_t& seed, const Type& arg) noexcept
{
    hashCombineArg(seed, arg);
}

template<typename Type, typename... Args>
MAGMA_INLINE void __nextHash(size_t& seed, const Type& arg, Args... args) noexcept
{
    hashCombineArg(seed, arg);
...
template<typename Type, typename... Args>
MAGMA_INLINE size_t hashVariadic(const Type& arg, Args... args) noexcept
{
    size_t value = 0;
