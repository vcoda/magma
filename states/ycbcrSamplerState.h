...
namespace magma
{
#define MAGMA_YCBCR_CONVERSION_SAMPLER_STATE_PERMUTATIONS(name, ycbcrModel)\
    ...
    namespace sampler
    {
        MAGMA_YCBCR_CONVERSION_SAMPLER_STATE_PERMUTATIONS(rgbIdentity, VK_SAMPLER_YCBCR_MODEL_CONVERSION_RGB_IDENTITY_KHR)
        MAGMA_YCBCR_CONVERSION_SAMPLER_STATE_PERMUTATIONS(ycbcrIdendity, VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_IDENTITY_KHR)
        MAGMA_YCBCR_CONVERSION_SAMPLER_STATE_PERMUTATIONS(ycbcr709, VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_709_KHR)
        MAGMA_YCBCR_CONVERSION_SAMPLER_STATE_PERMUTATIONS(ycbcr601, VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_601_KHR)
        MAGMA_YCBCR_CONVERSION_SAMPLER_STATE_PERMUTATIONS(ycbcr2020, VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_2020_KHR)
    } // namespace sampler
} // namespace magma
