...
namespace magma
{
#define MAGMA_DEFINE_RASTERIZATION_STATE_PERMUTATIONS(name, polygonMode)\
    ...
    {
        MAGMA_DEFINE_RASTERIZATION_STATE_PERMUTATIONS(fill, VK_POLYGON_MODE_FILL)
        MAGMA_DEFINE_RASTERIZATION_STATE_PERMUTATIONS(line, VK_POLYGON_MODE_LINE)
        MAGMA_DEFINE_RASTERIZATION_STATE_PERMUTATIONS(point, VK_POLYGON_MODE_POINT)
#ifdef VK_NV_fill_rectangle
        MAGMA_DEFINE_RASTERIZATION_STATE_PERMUTATIONS(fillRectangle, VK_POLYGON_MODE_FILL_RECTANGLE_NV)
#endif
    } // namespace renderstate
} // namespace magma
