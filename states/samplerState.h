...
namespace magma
{
#define MAGMA_DEFINE_SAMPLER_STATE_PERMUTATIONS(Suffix, addressMode)\
...
#define MAGMA_DEFINE_CUBIC_SAMPLER_STATE_PERMUTATIONS(Suffix, addressMode)\
...
#define MAGMA_DEFINE_CUBIC_SAMPLER_STATE_PERMUTATIONS(Suffix, addressMode)
    ...
    namespace sampler
    {
        MAGMA_DEFINE_SAMPLER_STATE_PERMUTATIONS(Repeat, VK_SAMPLER_ADDRESS_MODE_REPEAT)
        MAGMA_DEFINE_SAMPLER_STATE_PERMUTATIONS(MirroredRepeat, VK_SAMPLER_ADDRESS_MODE_MIRRORED_REPEAT)
        MAGMA_DEFINE_SAMPLER_STATE_PERMUTATIONS(ClampToEdge, VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE)
        MAGMA_DEFINE_SAMPLER_STATE_PERMUTATIONS(ClampToBorder, VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_BORDER)
#   ifdef VK_KHR_sampler_mirror_clamp_to_edge
        MAGMA_DEFINE_SAMPLER_STATE_PERMUTATIONS(MirrorClampToEdge, VK_SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE_KHR)
#   endif

        MAGMA_DEFINE_CUBIC_SAMPLER_STATE_PERMUTATIONS(Repeat, VK_SAMPLER_ADDRESS_MODE_REPEAT)
        MAGMA_DEFINE_CUBIC_SAMPLER_STATE_PERMUTATIONS(MirroredRepeat, VK_SAMPLER_ADDRESS_MODE_MIRRORED_REPEAT)
        MAGMA_DEFINE_CUBIC_SAMPLER_STATE_PERMUTATIONS(ClampToEdge, VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE)
        MAGMA_DEFINE_CUBIC_SAMPLER_STATE_PERMUTATIONS(ClampToBorder, VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_BORDER)
#   ifdef VK_KHR_sampler_mirror_clamp_to_edge
        MAGMA_DEFINE_CUBIC_SAMPLER_STATE_PERMUTATIONS(MirrorClampToEdge, VK_SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE_KHR)
#   endif
    } // namespace sampler
} // namespace magma
