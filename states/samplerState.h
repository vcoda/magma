...
namespace magma
{
    namespace sampler
    {
        ...
        constexpr SamplerState magLinearMinNearesetMipLinearMirrorClampToEdge(VK_FILTER_LINEAR, VK_FILTER_NEAREST, VK_SAMPLER_MIPMAP_MODE_LINEAR, VK_SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE_KHR);
        ...
        constexpr AnisotropicSamplerState magMinLinearMipAnisotropicMirrorClampToEdge(VK_FILTER_LINEAR, VK_FILTER_LINEAR, VK_SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE_KHR);
        ...
        constexpr AnisotropicSamplerState magMinCubicMipAnisotropicMirroredRepeat(VK_FILTER_CUBIC_EXT, VK_FILTER_CUBIC_EXT, VK_SAMPLER_ADDRESS_MODE_MIRRORED_REPEAT);
        ...
        constexpr AnisotropicSamplerState magMinCubicMipAnisotropicClampToEdge(VK_FILTER_CUBIC_EXT, VK_FILTER_CUBIC_EXT, VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE);
        ...
        constexpr AnisotropicSamplerState magMinCubicMipAnisotropicClampToBorder(VK_FILTER_CUBIC_EXT, VK_FILTER_CUBIC_EXT, VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_BORDER);
        ...
        constexpr AnisotropicSamplerState magMinCubicMipAnisotropicMirrorClampToEdge(VK_FILTER_CUBIC_EXT, VK_FILTER_CUBIC_EXT, VK_SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE_KHR);
#endif // VK_KHR_sampler_mirror_clamp_to_edge
